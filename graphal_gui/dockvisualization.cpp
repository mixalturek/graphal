...
DockVisualization::DockVisualization(QWidget* parent, Qt::WindowFlags flags)
	: QDockWidget(tr("Visualizations"), parent, flags),
	m_visualization(new Visualization(this))
{
	setWidget(m_visualization);
}

DockVisualization::~DockVisualization(void)
{
