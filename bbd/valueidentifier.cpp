...
PTR_Value ValueIdentifier::add(const ValueNull& left)       const { return static_cast<const Value&>(left).add(*getReferredValue()); }
PTR_Value ValueIdentifier::add(const ValueBool& left)       const { return static_cast<const Value&>(left).add(*getReferredValue()); }
PTR_Value ValueIdentifier::add(const ValueInt& left)        const { return static_cast<const Value&>(left).add(*getReferredValue()); }
PTR_Value ValueIdentifier::add(const ValueFloat& left)      const { return static_cast<const Value&>(left).add(*getReferredValue()); }
PTR_Value ValueIdentifier::add(const ValueString& left)     const { return static_cast<const Value&>(left).add(*getReferredValue()); }
PTR_Value ValueIdentifier::add(const ValueStruct& left)     const { return static_cast<const Value&>(left).add(*getReferredValue()); }
...
PTR_Value ValueIdentifier::sub(const ValueBool& left)       const { return static_cast<const Value&>(left).sub(*getReferredValue()); }
PTR_Value ValueIdentifier::sub(const ValueInt& left)        const { return static_cast<const Value&>(left).sub(*getReferredValue()); }
PTR_Value ValueIdentifier::sub(const ValueFloat& left)      const { return static_cast<const Value&>(left).sub(*getReferredValue()); }
PTR_Value ValueIdentifier::sub(const ValueString& left)     const { return static_cast<const Value&>(left).sub(*getReferredValue()); }
PTR_Value ValueIdentifier::sub(const ValueStruct& left)     const { return static_cast<const Value&>(left).sub(*getReferredValue()); }
...
PTR_Value ValueIdentifier::mult(const ValueBool& left)      const { return static_cast<const Value&>(left).mult(*getReferredValue()); }
PTR_Value ValueIdentifier::mult(const ValueInt& left)       const { return static_cast<const Value&>(left).mult(*getReferredValue()); }
PTR_Value ValueIdentifier::mult(const ValueFloat& left)     const { return static_cast<const Value&>(left).mult(*getReferredValue()); }
PTR_Value ValueIdentifier::mult(const ValueString& left)    const { return static_cast<const Value&>(left).mult(*getReferredValue()); }
PTR_Value ValueIdentifier::mult(const ValueStruct& left)    const { return static_cast<const Value&>(left).mult(*getReferredValue()); }
...
PTR_Value ValueIdentifier::div(const ValueBool& left)       const { return static_cast<const Value&>(left).div(*getReferredValue()); }
PTR_Value ValueIdentifier::div(const ValueInt& left)        const { return static_cast<const Value&>(left).div(*getReferredValue()); }
PTR_Value ValueIdentifier::div(const ValueFloat& left)      const { return static_cast<const Value&>(left).div(*getReferredValue()); }
PTR_Value ValueIdentifier::div(const ValueString& left)     const { return static_cast<const Value&>(left).div(*getReferredValue()); }
PTR_Value ValueIdentifier::div(const ValueStruct& left)     const { return static_cast<const Value&>(left).div(*getReferredValue()); }
...
PTR_Value ValueIdentifier::mod(const ValueBool& left)       const { return static_cast<const Value&>(left).mod(*getReferredValue()); }
PTR_Value ValueIdentifier::mod(const ValueInt& left)        const { return static_cast<const Value&>(left).mod(*getReferredValue()); }
PTR_Value ValueIdentifier::mod(const ValueFloat& left)      const { return static_cast<const Value&>(left).mod(*getReferredValue()); }
PTR_Value ValueIdentifier::mod(const ValueString& left)     const { return static_cast<const Value&>(left).mod(*getReferredValue()); }
PTR_Value ValueIdentifier::mod(const ValueStruct& left)     const { return static_cast<const Value&>(left).mod(*getReferredValue()); }
...
PTR_Value ValueIdentifier::eq(const ValueBool& left)        const { return static_cast<const Value&>(left).eq(*getReferredValue()); }
PTR_Value ValueIdentifier::eq(const ValueInt& left)         const { return static_cast<const Value&>(left).eq(*getReferredValue()); }
PTR_Value ValueIdentifier::eq(const ValueFloat& left)       const { return static_cast<const Value&>(left).eq(*getReferredValue()); }
PTR_Value ValueIdentifier::eq(const ValueString& left)      const { return static_cast<const Value&>(left).eq(*getReferredValue()); }
PTR_Value ValueIdentifier::eq(const ValueStruct& left)      const { return static_cast<const Value&>(left).eq(*getReferredValue()); }
...
PTR_Value ValueIdentifier::ne(const ValueBool& left)        const { return static_cast<const Value&>(left).ne(*getReferredValue()); }
PTR_Value ValueIdentifier::ne(const ValueInt& left)         const { return static_cast<const Value&>(left).ne(*getReferredValue()); }
PTR_Value ValueIdentifier::ne(const ValueFloat& left)       const { return static_cast<const Value&>(left).ne(*getReferredValue()); }
PTR_Value ValueIdentifier::ne(const ValueString& left)      const { return static_cast<const Value&>(left).ne(*getReferredValue()); }
PTR_Value ValueIdentifier::ne(const ValueStruct& left)      const { return static_cast<const Value&>(left).ne(*getReferredValue()); }
...
PTR_Value ValueIdentifier::le(const ValueBool& left)        const { return static_cast<const Value&>(left).le(*getReferredValue()); }
PTR_Value ValueIdentifier::le(const ValueInt& left)         const { return static_cast<const Value&>(left).le(*getReferredValue()); }
PTR_Value ValueIdentifier::le(const ValueFloat& left)       const { return static_cast<const Value&>(left).le(*getReferredValue()); }
PTR_Value ValueIdentifier::le(const ValueString& left)      const { return static_cast<const Value&>(left).le(*getReferredValue()); }
PTR_Value ValueIdentifier::le(const ValueStruct& left)      const { return static_cast<const Value&>(left).le(*getReferredValue()); }
...
PTR_Value ValueIdentifier::ge(const ValueBool& left)        const { return static_cast<const Value&>(left).ge(*getReferredValue()); }
PTR_Value ValueIdentifier::ge(const ValueInt& left)         const { return static_cast<const Value&>(left).ge(*getReferredValue()); }
PTR_Value ValueIdentifier::ge(const ValueFloat& left)       const { return static_cast<const Value&>(left).ge(*getReferredValue()); }
PTR_Value ValueIdentifier::ge(const ValueString& left)      const { return static_cast<const Value&>(left).ge(*getReferredValue()); }
PTR_Value ValueIdentifier::ge(const ValueStruct& left)      const { return static_cast<const Value&>(left).ge(*getReferredValue()); }
...
PTR_Value ValueIdentifier::lt(const ValueBool& left)        const { return static_cast<const Value&>(left).lt(*getReferredValue()); }
PTR_Value ValueIdentifier::lt(const ValueInt& left)         const { return static_cast<const Value&>(left).lt(*getReferredValue()); }
PTR_Value ValueIdentifier::lt(const ValueFloat& left)       const { return static_cast<const Value&>(left).lt(*getReferredValue()); }
PTR_Value ValueIdentifier::lt(const ValueString& left)      const { return static_cast<const Value&>(left).lt(*getReferredValue()); }
PTR_Value ValueIdentifier::lt(const ValueStruct& left)      const { return static_cast<const Value&>(left).lt(*getReferredValue()); }
...
PTR_Value ValueIdentifier::gt(const ValueBool& left)        const { return static_cast<const Value&>(left).gt(*getReferredValue()); }
PTR_Value ValueIdentifier::gt(const ValueInt& left)         const { return static_cast<const Value&>(left).gt(*getReferredValue()); }
PTR_Value ValueIdentifier::gt(const ValueFloat& left)       const { return static_cast<const Value&>(left).gt(*getReferredValue()); }
PTR_Value ValueIdentifier::gt(const ValueString& left)      const { return static_cast<const Value&>(left).gt(*getReferredValue()); }
PTR_Value ValueIdentifier::gt(const ValueStruct& left)      const { return static_cast<const Value&>(left).gt(*getReferredValue()); }
...
PTR_Value ValueIdentifier::member(const ValueReference& left)     const { return left.getReferredValue()->member(*static_cast<const Value*>(this)); }
PTR_Value ValueIdentifier::member(const ValueIdentifier& left)    const { return left.getReferredValue()->member(*static_cast<const Value*>(this)); }
...
PTR_Value ValueIdentifier::index(const ValueBool& left)      const { return static_cast<const Value&>(left).index(*getReferredValue()); }
PTR_Value ValueIdentifier::index(const ValueInt& left)       const { return static_cast<const Value&>(left).index(*getReferredValue()); }
PTR_Value ValueIdentifier::index(const ValueFloat& left)     const { return static_cast<const Value&>(left).index(*getReferredValue()); }
PTR_Value ValueIdentifier::index(const ValueString& left)    const { return static_cast<const Value&>(left).index(*getReferredValue()); }
PTR_Value ValueIdentifier::index(const ValueStruct& left)    const { return static_cast<const Value&>(left).index(*getReferredValue()); }
