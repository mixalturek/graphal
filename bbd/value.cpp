...
PTR_Value Value::add(const ValueReference& /* left */)  const { return VALUENULL; }
PTR_Value Value::add(const ValueIdentifier& /* left */) const { return VALUENULL; }
...
PTR_Value Value::sub(const ValueReference& /* left */)  const { return VALUENULL; }
PTR_Value Value::sub(const ValueIdentifier& /* left */) const { return VALUENULL; }
...
PTR_Value Value::mult(const ValueReference& /* left */) const { return VALUENULL; }
PTR_Value Value::mult(const ValueIdentifier& /* left */)const { return VALUENULL; }
...
PTR_Value Value::div(const ValueReference& /* left */)  const { return VALUENULL; }
PTR_Value Value::div(const ValueIdentifier& /* left */) const { return VALUENULL; }
...
PTR_Value Value::mod(const ValueReference& /* left */)  const { return VALUENULL; }
PTR_Value Value::mod(const ValueIdentifier& /* left */) const { return VALUENULL; }
...
PTR_Value Value::eq(const ValueReference& /* left */)   const { return VALUEBOOL_FALSE; }
PTR_Value Value::eq(const ValueIdentifier& /* left */)  const { return VALUEBOOL_FALSE; }
...
PTR_Value Value::ne(const ValueReference& /* left */)   const { return VALUEBOOL_TRUE; }
PTR_Value Value::ne(const ValueIdentifier& /* left */)  const { return VALUEBOOL_TRUE; }
...
PTR_Value Value::le(const ValueReference& /* left */)   const { return VALUEBOOL_FALSE; }
PTR_Value Value::le(const ValueIdentifier& /* left */)  const { return VALUEBOOL_FALSE; }
...
PTR_Value Value::ge(const ValueReference& /* left */)   const { return VALUEBOOL_FALSE; }
PTR_Value Value::ge(const ValueIdentifier& /* left */)  const { return VALUEBOOL_FALSE; }
...
PTR_Value Value::lt(const ValueReference& /* left */)   const { return VALUEBOOL_FALSE; }
PTR_Value Value::lt(const ValueIdentifier& /* left */)  const { return VALUEBOOL_FALSE; }
...
PTR_Value Value::gt(const ValueReference& /* left */)   const { return VALUEBOOL_FALSE; }
PTR_Value Value::gt(const ValueIdentifier& /* left */)  const { return VALUEBOOL_FALSE; }
...
PTR_Value Value::member(const ValueReference& /* left */) const { return VALUENULL; }
PTR_Value Value::member(const ValueIdentifier& /* left */)const { return VALUENULL; }
...
PTR_Value Value::index(const ValueReference& /* left */) const { return VALUENULL; }
PTR_Value Value::index(const ValueIdentifier& /* left */)const { return VALUENULL; }
