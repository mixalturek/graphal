...
Adresář \texttt{svn} obsahuje dump SVN repozitáře sloužícího pro vývoj a \texttt{svnstat} statistiky o tomto repozitáři vygenerované nástrojem StatSVN.
