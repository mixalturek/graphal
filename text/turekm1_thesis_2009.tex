...
Soubory ukládající grafy používají následující strukturu. Jedná se o~textový formát, oddělovačem může být libovolný počet bílých znaků (mezera, tabulátor, nový řádek).
