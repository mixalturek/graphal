...
#include "generated/nodebinarydiv.h"
#include "value.h"
...
NodeBinaryDiv::NodeBinaryDiv(Node* left, Node* right)
	: NodeBinary(left, right)
{

}

NodeBinaryDiv::~NodeBinaryDiv(void)
{
...
CountPtr<Value> NodeBinaryDiv::execute(void)
{
	return m_left->execute()->div(*(m_right->execute()));
}

void NodeBinaryDiv::dump(ostream& os, uint indent) const
{
	dumpIndent(os, indent);
	os << "<NodeBinaryDiv>" << endl;
