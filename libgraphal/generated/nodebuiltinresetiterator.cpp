...
NodeBuiltinResetIterator::NodeBuiltinResetIterator(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinResetIterator::~NodeBuiltinResetIterator(void)
{
...
CountPtr<Value> NodeBuiltinResetIterator::execute(void)
{
