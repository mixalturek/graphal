...
NodeBuiltinIsNull::NodeBuiltinIsNull(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinIsNull::~NodeBuiltinIsNull(void)
{
...
CountPtr<Value> NodeBuiltinIsNull::execute(void)
{
