...
NodeBuiltinIsArray::NodeBuiltinIsArray(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinIsArray::~NodeBuiltinIsArray(void)
{
...
CountPtr<Value> NodeBuiltinIsArray::execute(void)
{
