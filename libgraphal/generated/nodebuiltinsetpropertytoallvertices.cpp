...
NodeBuiltinSetPropertyToAllVertices::NodeBuiltinSetPropertyToAllVertices(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinSetPropertyToAllVertices::~NodeBuiltinSetPropertyToAllVertices(void)
{
...
CountPtr<Value> NodeBuiltinSetPropertyToAllVertices::execute(void)
{
	...
	if((g = par[0]->toValueGraph()) != NULL && (s = par[1]->toValueString()) != NULL)
		...
		WARN_P(_("Bad parameters type: setPropertyToAllVertices(graph, string, object) : null"));
