...
NodeBuiltinVisSetPos::NodeBuiltinVisSetPos(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinVisSetPos::~NodeBuiltinVisSetPos(void)
{
...
CountPtr<Value> NodeBuiltinVisSetPos::execute(void)
{
			...
			&& par[3]->isNumeric())
	{
		...
		WARN_P(_("Bad parameters type: visSetPos(vertex, number, number, number) : null"));
