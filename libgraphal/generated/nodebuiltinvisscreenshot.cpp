...
NodeBuiltinVisScreenshot::NodeBuiltinVisScreenshot(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinVisScreenshot::~NodeBuiltinVisScreenshot(void)
{
...
CountPtr<Value> NodeBuiltinVisScreenshot::execute(void)
{
