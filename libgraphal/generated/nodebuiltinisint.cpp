...
NodeBuiltinIsInt::NodeBuiltinIsInt(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinIsInt::~NodeBuiltinIsInt(void)
{
...
CountPtr<Value> NodeBuiltinIsInt::execute(void)
{
