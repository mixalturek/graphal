...
NodeBuiltinExit::NodeBuiltinExit(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinExit::~NodeBuiltinExit(void)
{
...
CountPtr<Value> NodeBuiltinExit::execute(void)
{
