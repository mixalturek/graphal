...
NodeBuiltinIsBool::NodeBuiltinIsBool(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinIsBool::~NodeBuiltinIsBool(void)
{
...
CountPtr<Value> NodeBuiltinIsBool::execute(void)
{
