...
#include "generated/nodebinarymod.h"
#include "value.h"
...
NodeBinaryMod::NodeBinaryMod(Node* left, Node* right)
	: NodeBinary(left, right)
{

}

NodeBinaryMod::~NodeBinaryMod(void)
{
...
CountPtr<Value> NodeBinaryMod::execute(void)
{
	return m_left->execute()->mod(*(m_right->execute()));
}

void NodeBinaryMod::dump(ostream& os, uint indent) const
{
	dumpIndent(os, indent);
	os << "<NodeBinaryMod>" << endl;
