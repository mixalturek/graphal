...
NodeBuiltinIsVertex::NodeBuiltinIsVertex(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinIsVertex::~NodeBuiltinIsVertex(void)
{
...
CountPtr<Value> NodeBuiltinIsVertex::execute(void)
{
