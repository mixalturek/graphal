...
NodeBuiltinIsGraph::NodeBuiltinIsGraph(identifier name, list<identifier>* parameters)
	: NodeFunctionBuiltin(name, parameters)
{

}

NodeBuiltinIsGraph::~NodeBuiltinIsGraph(void)
{
...
CountPtr<Value> NodeBuiltinIsGraph::execute(void)
{
