...
DialogReplace::DialogReplace(QWidget* parent, Qt::WindowFlags flags)
...
QTextDocument::FindFlags DialogReplace::getFlags(void) const
{
...
void DialogReplace::setFlags(QTextDocument::FindFlags flags)
{
